...
class InputMatakuliahController extends Controller
{
    /**
    ...
    public function index()
    {
            ...
            return view('input-matakuliah.index', [
                'usermatakuliah' => $usermatakuliah,
                'user' => $user,
                'kelas' => $kelas,
                'students' => $students,
                'active' => 'input-matakuliah',
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('input-matakuliah')->with('success', 'Berhasil Menambahakan Data Matakuliah Mahasiswa');
    }
    /**
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->to('input-matakuliah')->with('success', 'Berhasil Menghapus Data');
        } catch (QueryException $e) {
            if ($e->getCode() == '23000') {
                // Jika terjadi pelanggaran integritas konstrain foreign key,
                // maka tampilkan pesan error yang sesuai
                return redirect()->to('input-matakuliah')->with('error
                ...
                return redirect()->to('input-matakuliah')->with('error', 'Terjadi kesalahan saat menghapus data.');
            }
        }
    }
}
