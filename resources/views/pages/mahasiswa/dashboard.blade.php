                                ...
                                <tr>
                                    <td>
                                      @if ($jadwal->jadwalkuliah->hari->name == 'senin')
                                         <p>{{ $jadwal->jadwalkuliah->matakuliah->kode_matakuliah }} - {{ $jadwal->jadwalkuliah->matakuliah->name }} </br> Dosen : {{ $jadwal->jadwalkuliah->matakuliah->namaDosen->name }} </br> Jam : {{ $jadwal->jadwalkuliah->jam_ke }} </br> Ruangan : {{ $jadwal->jadwalkuliah->ruangan->name }}
                                        </p>
                                      @endif
                                    </td>
                                    <td>
